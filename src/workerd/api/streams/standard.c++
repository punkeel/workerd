...
public:
  ...
  kj::Own<ReadableStreamController> detach(jsg::Lock& js) override;
...
jsg::Promise<void> WritableImpl<Self>::close(jsg::Lock& js, jsg::Ref<Self> self) {
  ...
  if (backpressure && isWritable() && owner != nullptr) {
...
kj::Own<ReadableStreamController> ReadableStreamJsController::detach(jsg::Lock& js) {
